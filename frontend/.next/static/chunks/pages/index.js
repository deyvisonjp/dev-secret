...
})(["background-color:", ";color:", ";padding:20px;margin:20px;max-width:220px;height:160px;border-radius:10px;"], function (_ref) {
  var theme = _ref.theme;
  return theme.colors.primary;
}, function (_ref2) {
  var theme = _ref2.theme;
